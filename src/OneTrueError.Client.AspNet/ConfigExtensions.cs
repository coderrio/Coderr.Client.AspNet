...
namespace OneTrueError.Client
{
    ...
    public static class ConfigExtensions
    {
        ...
        ///         is used to store error reports until they have been successfully uploaded to OneTrueError. In that way we can
        ...
        /// </code>
        /// </remarks>
        public static void SetErrorPageGenerator(this OneTrueConfiguration configurator,

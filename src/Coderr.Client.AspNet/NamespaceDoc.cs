...
namespace codeRR.Client.AspNet
{
    ...
    ///     </para>
    ///     <para>
    ///         To use this package you have to install the <c>coderr.client.aspnet</c> nuget package. To active the package,
    ///         invoke <c>Err.Configuration.CatchAspNetErrors();</c>
    ///     </para>
    ///     <para>
    ...
    ///         the <c>coderr.client.aspnet.mvc5</c> package instead.
    ///     </para>
    ///     <para>
    ...
    ///         <code>
    /// Err.Configuration.SetErrorPageGenerator("~/views/error.aspx");
    /// </code>
    ///         <para>

...
namespace Coderr.Client
{
    ...
    public static class ConfigExtensions
    {
        ...
        public static void CatchAspNetExceptions(this CoderrConfiguration configurator)
        {
        ...
        ///     You have to have a <![CDATA[<form>]]> tag pointing at 'http://yourwebsite/coderr/' in your error page if you
        ///     would like to collect error information.\r\n(Or set Err.Configuration.AskUserForPermission and
        ///     Err.Configuration.AskUserForDetails to false)
        ///     or
        ...
        /// <remarks>
        ///     <para>
        ///         For this plugin to work, you need to make sure that the <code>App_Data</code> folder exists and that the
        ///         application pool account (typically IUSR) have write access to it. The folder
        ///         is used to store error reports until they have been successfully uploaded to codeRR. In that way we can
        ///         make sure that no reports are lost (even if there are network failure or other issues).
        ///     </para>
        ///     <para>
        ///         You can either return a complete error page (no virtual URIs for images etc) or a virtual path to a page which
        ///         will
        ///         create the error page.
        ///     </para>
        ///     <para>If you do the latter you can </para>
        ///     <para>
        ///         It's important that you've configured <c>Err.Configuration.AskUserForDetails</c> and
        ///         <c>Err.Configuration.AskUserForPermission</c> correctly if you
        ...
        ///             <term>$URL$</term>
        ///             <description>
        ///                 Full URL which will be picked up by the codeRR module (to be able to send the report
        ///                 to the codeRR service)
        ///             </description>
        ///         </item>
        ///         <item>
        ///             <term>$reportId$</term>
        ...
        /// </code>
        /// </remarks>
        public static void SetErrorPageGenerator(this CoderrConfiguration configurator,
            IErrorPageGenerator errorPageGenerator)
        {
